...
public class InstalacionAgua implements Instalacion {
    ...
    public void instalar() {
        System.out.println("--------------------------------------------------");
        System.out.println("SE REALIZO CON EXITO LA INSTALACION DE AGUA");
    ...
    public InstalacionAgua(double precio, String tipo, double metrosCuadrados, FormaPago formaPago) {
        this.precio = precio;
        this.tipo = tipo;
        this.metrosCuadrados = metrosCuadrados;
        this.formaPago = formaPago;
